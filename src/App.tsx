...
import { fetchNodeBalance, fetchNodeProposedBlocks, fetchMasternodes } from './lib/sdk';
import { Summary } from './components/Summary';
import { NodeTable } from './components/NodeTable';
import { NodeDetail } from './components/NodeDetail';
import type { DashboardData, LiveNodeData, MasternodeEntry, Network } from './types';
    ...
    <div className="app">
      ...
      {data && (
        <>
          ...
          <NodeTable data={data} now={now} selected={selected} onSelect={setSelected} />
          <footer>
            ...
            per-node balance and current-epoch queries run only on request · earnings are gross,
            before masternode reward shares · updated {new Date(data.fetchedAt).toLocaleTimeString()}{' '}
